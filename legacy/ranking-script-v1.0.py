...
def search_and_check_rank(keyword, region, target_url):
    ...
    try:
        ...
        print("Navigating to valentin.app...")
        driver.get("https://valentin.app")
        ...
        # Fetch 100 results at once to search from
        current_url = driver.current_url
        print(current_url)
        driver.get(current_url + "&num=100")
        ...
        #         EC.presence_of_element_located((By.CLASS_NAME, "g"))
        #     )
        #     print("100 Search results successfully loaded.")
        # except TimeoutException:
        #     print("Error: 100 Search results did not load in time.")
        #     return -1
